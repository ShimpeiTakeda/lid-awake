...
mkdir -p "$app_dir/Contents/Resources/ja.lproj"
...
install -m 644 "$repo_dir/Resources/en.lproj/Localizable.strings" \
  "$app_dir/Contents/Resources/en.lproj/Localizable.strings"
install -m 644 "$repo_dir/Resources/ja.lproj/Localizable.strings" \
  "$app_dir/Contents/Resources/ja.lproj/Localizable.strings"
...
plutil -insert CFBundleLocalizations -json '["en", "ja"]' "$app_dir/Contents/Info.plist"
...
plutil -insert CFBundleShortVersionString -string 0.3.0 "$app_dir/Contents/Info.plist"
